          ...
          <table border="0" cellpadding="5" cellspacing="0">
            <tr>
              ...
              <td>
                ...
                <table>
                  <tr>
                    <xsl:apply-templates select="notification_data/partner_shipping_info_list/partner_shipping_info[0]" />
                    <xsl:template match="notification_data/partner_shipping_info_list/partner_shipping_info[0]">
                      <td>
            ...
            <tr>
				      ...
				      <td><xsl:value-of select="substring(notification_data/partner_code, 4, 3)"/>&#160;&#160;<xsl:value-of select="substring(notification_data/partner_code, 7)"/></td>
			      </tr>
            <tr>
